...
var OBJDoc = function(fileName) {
    ...
    this.texCoords = new Array(0); // Initialize the property for texture coordinates
...
OBJDoc.prototype.getDrawingInfo = function() {
    ...
    for(var i = 0; i < this.objects.length; i++){
        ...
        for(var j = 0; j < object.faces.length; j++){
            ...
            for(var k = 0; k < face.vIndices.length; k++){
                ...
                texCoords[index_indices * 2 + 0] = texCoord.s;
                texCoords[index_indices * 2 + 1] = texCoord.t;
                // Copy normal
    ...
    return new DrawingInfo(vertices, texCoords, normals, colors, indices);
}
...
// DrawInfo Object
//------------------------------------------------------------------------------
var DrawingInfo = function(vertices, texCoords, normals, colors, indices) {
